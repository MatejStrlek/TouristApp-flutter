    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          switch (state) {
            LoadingState() => Expanded(child: Center(child: Lottie.asset("assets/animations/loading_sights.json", width: 100),)),
            EmptyState() => const Expanded(child: EmptyStateWidget()),
            ErrorState(failure: var failure) => Expanded(child: ErrorStateWidget(failure: failure)),
